...
namespace Capture.Hook {
    ...
    public class Hook<T> : Hook where T : class {
        /// <summary>
        ///     Creates a new hook at <paramref name="funcToHook" /> redirecting to <paramref name="newFunc" />. The hook starts
        ///     inactive so a call to <see cref="Activate" /> is required to enable the hook.
        /// </summary>
        ...
        /// <param name="owner">
        ///     The object to assign as the "callback" object within the <see cref="EasyHook.LocalHook" />
        ///     instance.
        /// </param>
        ...
        /// <summary>
        ///     When called from within the <see cref="Hook.NewFunc" /> delegate this will call the original function at
        ///     <see cref="Hook.FuncToHook" />.
        /// </summary>
    ...
    public class Hook : IDisposable {
        ...
        protected virtual void Dispose(bool disposeManagedObjects) {
            ...
            if (disposeManagedObjects) UnHook();
        }
    }
}